...
def videoSearch(max_limit, video_duration, search_keyword):
...
video_duration = input("Enter long or short:")
print(videoSearch(max_limit, video_duration, search_keyword))
